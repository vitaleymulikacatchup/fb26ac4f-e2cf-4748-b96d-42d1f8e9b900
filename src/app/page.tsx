    ...
    >
      ...
      <div id="product" data-section="product" className="scroll-mt-24 bg-pink-100">
        <div className="mx-auto px-4 md:px-6">
          <ProductCardOne
            products={[
              { id: '1', name: 'Margherita', price: '$12', imageSrc: 'asset://product' },
              { id: '2', name: 'Pepperoni', price: '$14', imageSrc: 'asset://product' },
              { id: '3', name: 'Vegetarian', price: '$11', imageSrc: 'asset://product' }
            ]}
            className="bg-pink-100"
